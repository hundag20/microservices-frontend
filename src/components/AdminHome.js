...
const AdminHome = () => {
  ...
  const asHandler = async () => {
    dispatch(featureActions.switch({ feature: "as" }));
  };
  ...
  sidebarOptions = [
    ...
    <li className="has-subnav">
      <a href="#" onClick={asHandler}>
        <i className="fa fas fa-laptop-medical"></i>
        <span className="nav-text">After Sales</span>
      </a>
    </li>,
  ];
  ...
  const Options = () => {
    ...
    else if (feature.feature && feature.feature === "as") return <AsHome />;
